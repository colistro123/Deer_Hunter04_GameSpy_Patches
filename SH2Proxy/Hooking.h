...
#ifdef _M_IX86
					DWORD oldProtect;
					VirtualProtect((void*)addressTableEntry, sizeof(function), PAGE_EXECUTE_READWRITE, &oldProtect);
					*addressTableEntry = (uintptr_t)function;
					VirtualProtect((void*)addressTableEntry, sizeof(function), oldProtect, &oldProtect);
#else
					*addressTableEntry = (uintptr_t)function;
#endif
					return origEntry;
